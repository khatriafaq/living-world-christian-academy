      ...
      <section className="main-container mb-0 xl:flex xxl:items-start justify-between text-white">
        ...
        <div className=" text-center lg:text-left xl:pt-10">
          <div>
            <h2 className="xl:whitespace-nowrap text-[28px] -tracking-[1.54px] md:text-[32px] lg:tracking-normal lg:text-[40px] xl:-mt-10 xxl:-mt-10">
              Virtual <span className="text-brandColor">X</span> is
              launching....
            </h2>
          </div>
          <div>
            <h1 className="mt-4 text-[44.89px] -tracking-[2.469px] md:text-[85px] xl:tracking-normal xxl:text-[90px] xxl:tracking-[-5.934px] xl:whitespace-nowrap hero-text">
              V <span className="text-brandColor">Mobile</span>
            </h1>
          </div>
          <h1 className="text-[44.89px] -tracking-[2.469px] leading-[105%] md:text-[85px] xl:tracking-normal xl:text-[65px] xxl:text-[90px] xxl:tracking-[-1.934px] xl:whitespace-nowrap hero-text">
            UK & EU&apos;<span className="text-dark2">s</span> <br />
            <span className="text-dark2">First</span> 5G{" "}
            <span className="text-dark2 ">Mobile</span>
            <br /> Network
          </h1>
          <button className="btn my-6 text-xl md:text-2xl xxl:text-4xl xxl:my-8">
            Powered by Blockchain.
          </button>
          <p className="sub-title-large xl:pb-2 xxl:pb-20">
            The future of Mobile is here
            <br /> powered by cryptocurrencies &<br /> blockchain technology.
          </p>
        </div>
        ...
        <div className="w-full xl:flex items-end xl:left-[127px] xxl:left-[112px] relative z-10 pt-4 -ml-6 mb-10 md:-ml-14 xl:-ml-0 xl:-mt-20 xl:pt-2 xl:-mb-[4rem] xl:-mr-2 xxl:-mt-24 xxl:mb-[3rem] xxl:-mr-10">
          <Image
            ...
            alt="phone"
            quality={90}
            className="scale-125 xl:scale-100"
          />
        </div>
      </section>
