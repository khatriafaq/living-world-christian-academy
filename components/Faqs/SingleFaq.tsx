...
const SingleFaq = ({ faq, isOpen, toggleFaq }: SingleFaqProps) => {
  return (
    <div className="border border-[#1A1A1A] mb-3 overflow-hidden rounded-lg transition-all ">
      <div
        className="flex justify-between items-center bg-[#1A1A1A] bg-gradient-to-r hover:from-bg1 hover:to-cyan-400 px-3 py-2 cursor-pointer text-white hover:text-black"
        onClick={toggleFaq}
      >
