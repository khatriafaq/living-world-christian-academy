  ...
  return (
    <section className="main-container mt-40" id="roadmap">
      <div className="max-w-[1440px] mx-auto roadmap-bg text-white">
        <h1 className="text-center text-6xl md:text-8xl xl:text-[140px] gradient-text uppercase mb-20">
          Roadmap
        </h1>
                ...
                >
                  <div
                    className={`number-container before:w-10 before:h-10 text-black ${
                      ...
                      "before:bg-[#25A0FF] after:border-l-[#25A0FF]"
                    } ${
              ...
              return (
                ...
                >
                  ...
                  <div className={`${item.no > 9 && "-ml-2"}`}>
                    <h4 className="text-lg whitespace-nowrap">{item.title}</h4>
                    <p className="text-dark2 min-h-[80px] leading-[20px] md:leading-6">
                      {item.desc}
                    </p>
                  </div>
                </div>
