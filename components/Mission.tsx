    ...
    <main className="overflow-x-hidden pt-2">
      ...
      <section className="main-container mb-0 xl:flex xxl:items-start justify-start text-white ">
        ...
        <div className="flex flex-col p-5 order-2 md:pl-24">
          ...
          <div className="relative text-xl leading-[150%] font-poppins text-lightsteelblue z-[1] mq450:text-base mq450:leading-[24px]">
            <p className="m-0">
              Our mission is to develop a vibrant community of lifelong
            </p>
            <p className="m-0">
              learners through accessible, inclusive, and innovative
            </p>
            <p className="m-0">
              education. Guided by collaborative engagement and
            </p>
            <p className="m-0">
              rooted in biblical values, we empower students to excel
            </p>
            <p className="m-0">
              spiritually, academically, socially, and personally.
            </p>
          </div>
        </div>
