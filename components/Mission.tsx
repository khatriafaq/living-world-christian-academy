  ...
  return (
    <main className="overflow-x-hidden pt-2 md:mt-10">
      ...
      >
        ...
        <div className="flex flex-col p-5 order-2 md:pl-32">
          ...
          <div className=" max-w-lg relative text-xl leading-[150%] font-poppins text-lightsteelblue z-[1] mq450:text-base mq450:leading-[24px]">
            <p className="m-0 leading-9">
              Our mission is to develop a vibrant community of lifelong learners
              through accessible, inclusive, and innovative education. Guided by
              collaborative engagement and rooted in biblical values, we empower
              students to excel spiritually, academically, socially, and
              personally.
            </p>
          </div>
        </div>
